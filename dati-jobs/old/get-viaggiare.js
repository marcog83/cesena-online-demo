...
var categories = require("./viaggiare-categories");
...
fs.readFile("places.json", 'utf8', function (err, data) {
    ...
    places = places
        .filter(function (place) {
            ...
            return place && categories.indexOf(place.category_list[0].id) != -1;
        })
    ...
    fs.writeFile("client/partials/viaggiare-list.html", resultHTML, function (err) {
        if (err) {
            console.log(err);
            process.exit(1);
